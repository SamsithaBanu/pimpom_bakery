...
export const UploadProductStyled = styled.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
  ...
  .uploadProductWrapper {
    width: 650px;
    max-height: 90%; /* Allow space for scrolling */
    padding: 0px;
    display: flex;
    ...
    .productWrapper {
      ...
      overflow-y: auto; /* Allow scrolling within the productWrapper */
